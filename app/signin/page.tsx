...
import { Sparkles, Eye, EyeOff, ArrowLeft, Brain, Target, Users, BarChart, Lightbulb, Shield } from 'lucide-react';
...
const slides = [
  {
    ...
    description: "Get personalized business recommendations tailored to your unique goals and industry.",
    color: "from-primary to-secondary"
  },
  {
    icon: Brain,
    title: "Smart Guidance",
    description: "Advanced algorithms analyze your profile to provide strategic business advice.",
    color: "from-secondary to-accent"
  },
  {
    icon: Target,
    title: "Goal-Oriented Planning",
    description: "Customized roadmaps designed to help you achieve your entrepreneurial objectives.",
    color: "from-accent to-success"
  },
  {
    icon: Users,
    title: "Market Intelligence",
    description: "Deep insights into customer behavior and market trends for your industry.",
    color: "from-success to-primary"
  },
  {
    icon: BarChart,
    title: "Growth Analytics",
    description: "Track your progress with intelligent metrics and performance indicators.",
    color: "from-primary to-warning"
  },
  {
    icon: Shield,
    title: "Secure Platform",
    description: "Enterprise-grade security protecting your business data and personal information.",
            ...
            <div className="bg-gradient-to-br from-primary/10 to-secondary/10 rounded-3xl p-12 h-full min-h-[600px] flex flex-col justify-center items-center text-center space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-lg text-gray-600 max-w-md">
                  Join thousands of entrepreneurs who trust FedVentura for personalized business guidance powered by AI.
                </p>
              </div>

              <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-sm transition-all duration-500 transform">
                <div className={`w-16 h-16 bg-gradient-to-br ${currentSlideData.color} rounded-xl mx-auto mb-6 flex items-center justify-center transition-all duration-500`}>
